      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
          <div>
            ...
            <p className="font-lato text-sm text-beige leading-relaxed">
              Belleza que te hace brillar. Productos premium seleccionados con
              amor para realzar tu belleza natural.
            </p>
          </div>
          <div>
